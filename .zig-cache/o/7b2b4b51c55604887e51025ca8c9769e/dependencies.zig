pub const packages = struct {
    ...
    pub const @"zquic-0.8.4-2rPds3B2nBMALCDhmajScyilFa0Q0IdbWBFLwqsDSAVG" = struct {
        pub const build_root = "/home/chris/.cache/zig/p/zquic-0.8.4-2rPds3B2nBMALCDhmajScyilFa0Q0IdbWBFLwqsDSAVG";
        pub const build_zig = @import("zquic-0.8.4-2rPds3B2nBMALCDhmajScyilFa0Q0IdbWBFLwqsDSAVG");
        pub const deps: []const struct { []const u8, []const u8 } = &.{
...
pub const root_deps: []const struct { []const u8, []const u8 } = &.{
    .{ "zsync", "zsync-0.5.4-KAuheV0SHQBxubuzXagj1oq5B2KE4VhMWTAAAaInwB2_" },
    .{ "zcrypto", "zcrypto-0.8.6-rgQAI9g9DQDTxLJBz5QS6eF5rDIYloue7jV5YZysZCYl" },
    .{ "zquic", "zquic-0.8.4-2rPds3B2nBMALCDhmajScyilFa0Q0IdbWBFLwqsDSAVG" },
};
